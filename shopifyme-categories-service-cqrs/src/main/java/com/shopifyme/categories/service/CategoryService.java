...
public class CategoryService {
	...
	public CategoryBean updateCategory(CategoryBean categoryBean) {
		...
		categoryEntity = repo.findById(categoryBean.getId()).get();
		...
		/*
		   when category has been updated, it needs to push its update to all
		   the consumers of the category service
		*/
		commandHandler.publishCategoryUpdates(categoryBean);
		return categoryBean;
	}
